...
import { Card, LoadingSpinner } from "../components/MyUtilities";
...
export default function Dashboard() {
  ...
  if (loading) {
    return <LoadingSpinner txt="statistics" />
  }
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
        <Card
          className="border-l-4 border-blue-500 flex flex-col sm:flex-row items-center sm:items-start p-3 md:p-6 sm:space-x-4 mb-0"
        ...
        <Card
          className="border-l-4 border-pink-500 flex flex-col sm:flex-row items-center sm:items-start p-3 md:p-6 sm:space-x-4 mb-0"
          onClick={() => navigate("/articles")}
        >
        ...
        <Card
          className="border-l-4 border-emerald-500 flex flex-col sm:flex-row items-center sm:items-start p-3 md:p-6 sm:space-x-4 mb-0"
        ...
        <Card
          className="border-l-4 border-amber-500 flex flex-col sm:flex-row items-center sm:items-start p-3 md:p-6 sm:space-x-4 mb-0"
              ...
              stats.topArticles.map((article, index) => (
                <div key={article.id} className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  ...
                  <div className="ml-4 flex-shrink-0">
                    <div className="px-2 py-1 bg-pink-50 text-pink-600 rounded text-[10px] font-bold uppercase tracking-wider">
                      Top {index + 1}
                    </div>
                  </div>
                </div>
        ...
        <Card className="p-5 md:p-6 bg-gradient-to-br from-indigo-600 to-blue-700 text-white border-0 mb-0">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="bg-white/10 p-3 md:p-4 rounded-xl backdrop-blur-sm border border-white/10">
              <div className="text-[10px] text-pink-200 uppercase mb-1 font-semibold tracking-wider">Avg. Views per Article</div>
